    ...
    imports: [RouterModule.forChild( [
        {
            ...
            children: [{
                ...
                children: [
                    { path: '', canActivate: [AuthGuard], component: Child2Component },
                    {
                        path: ':id', component: Child3Component, canDeactivate: [CanDeactivateGuard],
                        resolve: { childrenResolve: ChildrenResolve }
                    }
                ]
            }]
        },
